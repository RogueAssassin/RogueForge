...
For 1.0.0-rc1 the compact tag is `100rc1`. Production CI may create the immutable Git tag `v<VERSION>` after a successful publish.
...
podman pull ghcr.io/rogueassassin/rogueforge:1.0.0-rc1
```
