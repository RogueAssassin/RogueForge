...
For 1.9.0 the compact tag is `190`. Production CI may create the immutable Git tag `v<VERSION>` after a successful publish.
...
podman pull ghcr.io/rogueassassin/rogueforge:1.9.0
```
