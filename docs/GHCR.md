...
For 0.8.7 the compact tag is `087`. Production CI may create the immutable Git tag `v<VERSION>` after a successful publish.
...
podman pull ghcr.io/rogueassassin/rogueforge:0.8.7
```
