...
For 1.6.0 the compact tag is `160`. Production CI may create the immutable Git tag `v<VERSION>` after a successful publish.
...
podman pull ghcr.io/rogueassassin/rogueforge:1.6.0
```
